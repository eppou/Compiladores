...
%%
    S
        ...
        |SHOW SYMBOLS SEMICOLON EOL {return ENDL;}
    ...
    matrix
        : LBRACKET LBRACKET NUM_INT loop_num RBRACKET loop_matrix
    ...
    loop_matrix
        :COMMA LBRACKET NUM_INT COMMA loop_num RBRACKET loop_matrix{}
        |{};
